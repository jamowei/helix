...
* Static commands: commands like `move_char_right` which are usually bound to
  ...
  in [`helix-term/src/commands.rs`](https://github.com/jamowei/helix/blob/master/helix-term/src/commands.rs)
...
* Typable commands: commands that can be executed from command mode (`:`), for
  ...
  the source code at [`helix-term/src/commands/typed.rs`](https://github.com/jamowei/helix/blob/master/helix-term/src/commands/typed.rs).
...
supports the [enhanced keyboard protocol](https://github.com/jamowei/helix/wiki/Terminal-Support#enhanced-keyboard-protocol).
