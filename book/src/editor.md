...
[^3]: In most cases, you also need to enable the `auto-format` setting under `languages.toml`. You can find the reasoning [here](https://github.com/jamowei/helix/discussions/9043#discussioncomment-7811497).
...
| Key | Description | Default |
|--|--|---------|
| `focus-lost` | Enable automatic saving on the focus moving away from Helix. Requires [focus event support](https://github.com/jamowei/helix/wiki/Terminal-Support) from your terminal | `false` |
